        ...
        unsigned char *data)
{
    ...
    if (tmp[1] + length > st.hw->bank_size)
	{
		uart_printf("mpu_read log: -3\r\n");
		return -3;
	}

    if (MPU_Write_Len(st.hw->addr, st.reg->bank_sel, 2, tmp))
	{
		uart_printf("mpu_read log: -4\r\n");
		return -4;
	}
    if (MPU_Read_Len(st.hw->addr, st.reg->mem_r_w, length, data))
	{
		uart_printf("mpu_read log: -5\r\n");
		return -5;
	}
    return 0;
}
    ...
    unsigned short start_addr, unsigned short sample_rate)
{
    ...
    for (ii = 0; ii < length; ii += this_write) {
		...
		{
			//int mpu_write_log;
			//mpu_write_log = mpu_write_mem(ii, this_write, (unsigned char*)&firmware[ii]);
			//uart_printf("mpu_write log: %d\r\n", mpu_write_log);
			return -3;
		}
		...
		{
			//int mpu_read_log;
			//mpu_read_log = mpu_read_mem(ii, this_write, cur);
			//uart_printf("mpu_write log: %d\r\n", mpu_read_log);
			return -4;
		}
...
uint8_t mpu_dmp_init(void)
{
	...
	// dmp_i2c_read(HW_S_HW_MPU_ADDR, MPU_DEVICE_ID, I2C_MEMADD_SIZE_8BIT,temp);
	IIC_Init();
	res=MPU_Read_Byte(MPU_DEVICE_ID_REG);
	//temp[0] = w_mpu_read_device_address();
 
	uart_printf("\r\n");
	uart_printf("Device_ID:    0x%x\r\n", res);
	uart_printf("\r\n");
 
	//检查ID，不对系统复位
	if(res != 0x68)
	{
		uart_printf("Device_ID Wrong\r\n", res);
		while(1);
	}
	...
	if(!mpu_init())
	{
		...
		{
			uart_printf("mpu_set_sensor complete ......\r\n");
			uart_printf("mpu设置传感器完成 ......\r\n");
		}
		else
			uart_printf("mpu_set_sensor incomplete ......\r\n");
			uart_printf("\r\n");
 
		//配置FIFO
		if(!mpu_configure_fifo(INV_XYZ_GYRO | INV_XYZ_ACCEL))
		{
			uart_printf("mpu_configure_fifo complete ......\r\n");
			uart_printf("mpu配置FIFO完成 ......\r\n");
		}
		else
			uart_printf("mpu_configure_fifo incomplete ......\r\n");
			uart_printf("\r\n");
 
		//配置采样频率分频寄存器
		if(!mpu_set_sample_rate(DEFAULT_MPU_HZ)) //#define DEFAULT_MPU_HZ  (100) //输出的速度, 100Hz, 10ms
		{
			uart_printf("mpu_set_sample_rate complete ......\r\n");
			uart_printf("mpu设定的采样率完成 ......\r\n");
		}
		else
			uart_printf("mpu_set_sample_rate incomplete ......\r\n");
			uart_printf("\r\n");
 
		//DMP加载动作驱动程序固件完成
//		if(!dmp_load_motion_driver_firmware())
//		{
//			uart_printf("dmp_load_motion_driver_firmware complete ......\r\n");
//			uart_printf("DMP加载动作驱动程序固件完成 ......\r\n");
//		}
//		else
		{
			int dmp_frimware_state;
			dmp_frimware_state = dmp_load_motion_driver_firmware();
			uart_printf("dmp_load_motion_driver_firmware ......\r\n");
		...
		{
			uart_printf("dmp_set_orientation complete ......\r\n");
			uart_printf("DMP设置陀螺仪方向完成 ......\r\n");
		}
		else
			uart_printf("dmp_set_orientation incomplete ......\r\n");
			uart_printf("\r\n");
		...
		{
			uart_printf("dmp_enable_feature complete ......\r\n");
			uart_printf("DMP使功能完整 ......\r\n");
		}
		else
			uart_printf("dmp_enable_feature incomplete ......\r\n");
			uart_printf("\r\n");
 
		//DMP设定FIFO速率完成
		if(!dmp_set_fifo_rate(DEFAULT_MPU_HZ)) //#define DEFAULT_MPU_HZ  (100) //输出的速度, 100Hz, 10ms
		{
			uart_printf("dmp_set_fifo_rate complete ......\r\n");
			uart_printf("DMP设定FIFO速率完成 ......\r\n");
		}
		else
			uart_printf("dmp_set_fifo_rate incomplete ......\r\n");
			uart_printf("\r\n");
		...
		{
			uart_printf("mpu_set_dmp_state complete ......\r\n");
			uart_printf("mpu设置DMP状态完成 ......\r\n");
		}
		else
			uart_printf("mpu_set_dmp_state incomplete ......\r\n");
			uart_printf("\r\n\r\n\r\n");
 
//		uart_printf(" ################### ...... 测试MPU姿态角度 ...... ################### \r\n");
// 
//		//先读取姿态角一段时间
//		{
...
//			uart_printf("Pitch: %f\t ", pitch);
//			uart_printf("Roll:  %f\t ", roll);
//			uart_printf("Yaw:   %f\t ", yaw);
//			uart_printf("\r\n");
//			portEXIT_CRITICAL();
//		}
		
		uart_printf(" ################### ...... MPU配置完成, DMP功能完成 ...... ################### \r\n");
	}
	return 0;
}
...
uint8_t mpu_dmp_get_data(float *pitch,float *roll,float *yaw)
{
	...
	{
		//uart_printf("DMP get data from fifo.\r\n");	
		//uart_printf("debug-- sensor: %d\r\n", sensors);
		//uart_printf("debug-- gyro: %d\r\n", gyro[0]);
		//uart_printf("dmp read fifo return:%d\r\n",dmp_read_fifo(gyro, accel, quat, &sensor_timestamp, &sensors,&more));
		return 1;
	}
	...
	**/
	if(sensors&INV_WXYZ_QUAT) 
	{
		...
		*yaw   = atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3;	//yaw
		//uart_printf("DMP Caculate finished.\r\n");
	}else return 2;
	return 0;
}
